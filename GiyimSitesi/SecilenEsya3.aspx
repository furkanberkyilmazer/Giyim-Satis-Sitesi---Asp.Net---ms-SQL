<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SecilenEsya3.aspx.cs" Inherits="SecilenEsya3" %>
    ...
    <!-- Navigation --> 
         ...
         <div id="navigation">
             <ul>
                 ...
                 <li><a href="Kadin.aspx" class="active">Kadın</a></li>
...
<div class="box categories">
                ...
                <div class="box-content">
                   ...
                   <ItemTemplate >
                   <a href="SecilenEsya3.aspx?urunAdi=<%#Eval("urunAdi") %>"><%#Eval("urunAdi")%></a>
                   </ItemTemplate>
                   <SeparatorTemplate>
                   <br/>
                   </SeparatorTemplate>
