<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SecilenEsya2.aspx.cs" Inherits="SecilenEsya2" %>
    ...
    <!-- Navigation --> 
         ...
         <div id="navigation">
             <ul>
                 ...
                 <li><a href="Erkek.aspx" class="active">Erkek</a></li>
...
<div class="box categories">
                ...
                <div class="box-content">
                   ...
                   <ItemTemplate >
                   <a href="SecilenEsya2.aspx?urunAdi=<%#Eval("urunAdi") %>"><%#Eval("urunAdi")%></a>
                   </ItemTemplate>
                   <SeparatorTemplate>
                   <br/>
                   </SeparatorTemplate>
