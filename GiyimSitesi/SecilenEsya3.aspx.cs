...
public partial class SecilenEsya3 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlCommand kmt = new SqlCommand("Select urunId,urunMarka,urunFiyat,urunResim,urunCinsiyet from urunler where urunTur=@urunTur and urunCinsiyet=@urunCinsiyet", bag);
        kmt.Parameters.AddWithValue("@urunTur", Request.QueryString["urunAdi"]);
        kmt.Parameters.AddWithValue("@urunCinsiyet", "Kadın");
        bag.Open();
