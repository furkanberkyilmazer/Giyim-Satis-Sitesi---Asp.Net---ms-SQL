<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="sepetDuzenle.aspx.cs" Inherits="sepetDuzenle" %>
...
&nbsp;
        ...
        <asp:ImageButton ID="btnEkle" runat="server" Height="76px" 
            ImageUrl="~/css/images/duzenlebitir.png" onclick="ImageButton2_Click" 
            Width="126px" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
