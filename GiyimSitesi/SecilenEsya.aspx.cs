...
public partial class SecilenEsya : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlCommand kmt = new SqlCommand("Select urunId,urunMarka,urunFiyat,urunResim,urunCinsiyet from urunler where urunTur=@urunTur", bag);
